...
<head>
    ...
    <title>Ver Observaciones - Valbuena Abogados</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <h1 class="mt-5">Observaciones del Caso</h1>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <c:forEach var="observacion" items="${observaciones}">
                            <tr>
                                <td>${observacion.idObservacion}</td>
                                <td>${observacion.comentario}</td>
                                <td>${observacion.autor}</td>
                                <td>${observacion.fechaCreacion}</td>
                                <td>
                                    <a href="gestionarObservaciones?action=editar&id=${observacion.idObservacion}" class="btn btn-warning">Editar</a>
                                    <a href="gestionarObservaciones?action=eliminar&id=${observacion.idObservacion}" class="btn btn-danger">Eliminar</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
                ...
                <a href="gestionarCasos?action=listar" class="btn btn-secondary">Regresar a la Lista de Casos</a>
            </div>
        </div>
    </div>
