...
<head>
    ...
    <title>Editar Notificación - Valbuena Abogados</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <h1 class="mt-5">Editar Notificación</h1>

                <form action="gestionarAlertas" method="post" class="mt-3">
                    <input type="hidden" name="action" value="editar">
                    <input type="hidden" name="id_notificacion" value="${notificacion.idNotificacion}">

                    <div class="mb-3">
                        <label for="mensaje" class="form-label">Mensaje</label>
                        <textarea id="mensaje" name="mensaje" class="form-control" rows="3" required>${notificacion.mensaje}</textarea>
                    </div>

                    <div class="mb-3">
                        <label for="id_usuario" class="form-label">ID Usuario</label>
                        <input type="number" id="id_usuario" name="id_usuario" class="form-control" value="${notificacion.idUsuario}" required>
                    </div>

                    <!-- Botones alineados -->
                    <div class="d-flex justify-content-end">
                        <button type="submit" class="btn btn-primary me-2">Actualizar Notificación</button>
                        <a href="gestionarAlertas?action=listar" class="btn btn-secondary">Regresar a la lista</a>
                    </div>
                </form>
            </div>
        </div>
